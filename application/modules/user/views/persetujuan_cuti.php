                                                        ...
                                                        <form action="<?= base_url('admin/edit_persetujuan/') . $datacuti['id']; ?>" method="POST">
                                                            <div class="row g-3">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <button class="form-control btn btn-info" href="<?= base_url('assets/data/karyawan/surat/' . $datacuti['surat']) ?>" target="_blank"><i class="fas fa-download"></i>Unduh Surat</button>
                                                                </div>
                                                                <div class="col-md-12">
