        ...
        <div class="col-lg-12 col-md-12 col-12 m-auto">
            ...
            <div class="col-xl-12 col-md-12 mb-4">
                <form action="" method="post" enctype="multipart/form-data" class="mt-5">
                    ...
                    <input type="hidden" name="nik" value="<?php echo $profil['nik'] ?>" />
                    ...
                    <div class="form-group form-row mb-4">
                        ...
                        <div class="col-3">
                            ...
                            <div class="img">
                                <img class="border-right rounded-lg shadow img-thumbnail" name="foto" src="<?= base_url('assets/data/karyawan/profil/' . $profil['foto']); ?>" alt="" style="height: 200px; width: 170px">
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="jeniskel" class="form-control form-select shadow" name="jeniskel" required>
                                <option value="<?= $profil['jenis_kelamin'] ?>"><?php if ($profil['jenis_kelamin'] == 'L') {
                                                                                    echo 'Laki-laki';
                                                                                } else if ($profil['jenis_kelamin'] == 'P') {
                                                                                    echo 'Perempuan';
                                                                                } else {
