        ...
        <div class="col-lg-12 col-md-12 col-12 m-auto">
            ...
            <div class="col-xl-12 col-md-12 mb-4">
                <form action="" method="post" enctype="multipart/form-data" class="mt-5">
                    ...
                    <input type="hidden" name="kd_admin" value="<?php echo $profil['kd_admin'] ?>" />
                    ...
                    <div class="form-group form-row mb-4">
                        ...
                        <div class="col-3">
                            ...
                            <div class="img">
                                <img class="border-right rounded-lg shadow img-thumbnail" name="foto" src="<?= base_url('assets/data/admin/profil/' . $profil['foto']); ?>" alt="" style="height: 200px; width: 170px">
                            </div>
                        </div>
