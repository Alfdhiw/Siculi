        ...
        <div class="col-xl-12 col-md-12 mb-6">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="fa-regular fa-pen-to-square"></i> Data Cuti Karyawan</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <table class="table table-hover table-bordered datacutikar" id="datacutikar" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['from']) && isset($_GET['to'])) {
                                    ...
                                    $data = mysqli_query($con, "SELECT k.nama, k.nik, c.* FROM tbl_karyawan k, tbl_cuti c WHERE k.id = c.id_karyawan and c.tgl_upload BETWEEN '" . $_GET['from'] . "' and '" . $_GET['to'] . "'");
                                } else {
                                    //jika tidak ada tanggal dari dan tanggal ke maka tampilkan seluruh data
                                    $data = mysqli_query($con, "SELECT k.nama, k.nik, c.* FROM tbl_karyawan k, tbl_cuti c WHERE k.id = c.id_karyawan");
                                }
                                while ($d = mysqli_fetch_array($data)) {
                                ?>
                                    <tr>
                                        <td class="text-center"><a href="<?= base_url('admin/detail_karyawan/' . $d['id_karyawan'])  ?>"><b><?= $d['nik']; ?></b> <i class="fa-solid fa-eye"></i></a></td>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a type="button" class="btn btn-primary" href="<?= base_url('admin/delete_cuti/' . $d['id']) ?>">Iya, Saya Yakin</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="fa-regular fa-pen-to-square"></i> Data Cuti Atasan</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-6 col-md-6 mb-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered datacutiatas" id="datacutiatas" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['from']) && isset($_GET['to'])) {
                                    // tampilkan data yang sesuai dengan range tanggal yang dicari 
                                    $data = mysqli_query($con, "SELECT k.nama, k.nik, c.* FROM tbl_atasan k, tbl_cuti c WHERE k.kd_atasan = c.id_karyawan and c.tgl_upload BETWEEN '" . $_GET['from'] . "' and '" . $_GET['to'] . "'");
                                } else {
                                    //jika tidak ada tanggal dari dan tanggal ke maka tampilkan seluruh data
                                    $data = mysqli_query($con, "SELECT k.nama, k.nik, c.* FROM tbl_atasan k, tbl_cuti c WHERE k.kd_atasan = c.id_karyawan");
                                }
                                while ($d = mysqli_fetch_array($data)) {
                                ?>
                                    <tr>
                                        <td class="text-center"><a href="<?= base_url('admin/detail_atasan/' . $d['id_karyawan'])  ?>"><b><?= $d['nik']; ?></b> <i class="fa-solid fa-eye"></i></a></td>
                                        <td class="text-center"><b><?= $d['nama']; ?></b></td>
                                        <td class="text-center"><b><?= date('j F Y', strtotime($d['tgl_cuti'])) ?></b></td>
                                        <td class="text-center"><b><?= date('j F Y', strtotime($d['tgl_masuk'])) ?></b></td>
                                        <td class="text-center"><b><?= $d['jenis_cuti'] ?></b></td>
