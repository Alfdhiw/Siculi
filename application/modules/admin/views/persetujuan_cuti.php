                                ...
                                <?php foreach ($datacuti as $datacuti) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><b><?php if ($datacuti['status'] == 'Approved') {
                                                                    ...
                                                                    ?></b></td>
                                        <td class="text-center"><span><a type="button" class="badge badge-success" href="" data-toggle="modal" data-target="#editModal<?= $datacuti['id']; ?>"><i class="fas fa-edit"></i> <span style="font-size:15px;">Edit</span></a></span></td>
                                        <!-- Modal Edit Cuti -->
                                                        ...
                                                        <form action="<?= base_url('admin/edit_persetujuan/') . $datacuti['id']; ?>" method="POST">
                                                            <div class="row g-3">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <input type="email" class="form-control" id="email" name="email" value="<?= $datacuti['user'] ?>" readonly>
                                                                </div>
                                                                <div class="col-12">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <button class="form-control btn btn-info" href="<?= base_url('assets/data/karyawan/surat/' . $datacuti['surat']) ?>" target="_blank"><i class="fas fa-download"></i>Unduh lampiran</button>
                                                                </div>
                                                                <div class="col-md-12">
