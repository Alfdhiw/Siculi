...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 mb-6">
            <div class="alert alert-success shadow" role="alert">
                ...
                <p>Kepegawaian yang di daftarkan secara default memiliki Username dan Password sebagai berikut :</p>
                <hr>
                <p><strong>Username :</strong> <i>Email yang digunakan untuk pendaftaran</i><br>
                    <strong>Password :</strong> 12345
                </p>
                <p>Sarankan kepada kepegawaian agar segera mengganti password di akun masing-masing</p>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-5">
        <div class="col-xl-12 col-md-12 mb-6">
            ...
            <form class="row g-3" action="<?= base_url('admin/tambah_kepegawaian/'); ?>" method="POST">
                <div class="col-md-6">
