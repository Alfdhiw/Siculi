                                ...
                                <?php foreach ($datacuti as $datacuti) : ?>
                                    <tr>
                                        ...
                                        if ($datacuti['status'] == 'Approved') {
                                            echo '<td class="text-center"><span><button type="button" class="btn btn-success btn-sm disabled" href="" ><i class="fas fa-edit"></i> <span style="font-size:15px;">Edit</span></button></span></td>';
                                        } elseif ($datacuti['status'] == 'Rejected') {
                                            echo '<td class="text-center"><span><a type="button" class="btn btn-success btn-sm" href="" data-toggle="modal" data-target="#editModal' . $datacuti['id'] . '"><i class="fas fa-edit"></i> <span style="font-size:15px;">Edit</span></a></span></td>';
                                        } elseif ($datacuti['status'] == 'Process') {
                                            echo '<td class="text-center"><span><a type="button" class="btn btn-success btn-sm" href="" data-toggle="modal" data-target="#editModal' . $datacuti['id'] . '"><i class="fas fa-edit"></i> <span style="font-size:15px;">Edit</span></a></span></td>';
                                        }
                                        ?>
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-left">
                                                        <form action="<?= base_url('admin/edit_ijin/') . $datacuti['id'] ?>" method="POST">
                                                            <div class="row g-3">
                                                                <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" id="atasan" name="atasan" value="<?= $datacuti['atasan'] ?>" readonly>
                                                                </div>
                                                                <div class="col-12">
