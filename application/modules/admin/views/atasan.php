                        ...
                        <table class="table table-hover table-bordered datakar" id="datakar" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php foreach ($atasan as $atasan) : ?>
                                    <tr>
                                        <td class="text-center"><a href="<?= base_url('admin/detail_atasan/' . $atasan['kd_atasan'])  ?>"><b><?= $atasan['nik']; ?></b> <i class="fa-solid fa-eye"></i></a></td>
                                        ...
                                        <td class="text-center">
                                            <span><a type="button" class="badge badge-success" href="" data-bs-toggle="modal" data-bs-target="#editModal<?= $atasan['kd_atasan'] ?>"><i class="fa-solid fa-pen-to-square"></i> <span style="font-size:15px;">Edit</span></a></span>

                                            <!-- Modal Edit kepegawaian -->
                                            <div class="modal fade" id="editModal<?= $atasan['kd_atasan'] ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-scrollable">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-left">
                                                            <form action="<?= base_url('admin/edit_atasan/') . $atasan['kd_atasan']; ?>" method="POST">
                                                                <div class="row g-3">
                                                                    <div class="col-md-6">
                                                                        <label for="nik" class="form-label">NIP</label>
                                                                        <input type="text" class="form-control" id="nik" name="nik" value="<?= $atasan['nik'] ?>" readonly>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="nama" class="form-label">Nama</label>
                                                                        <input type="text" class="form-control" id="nama" name="nama" value="<?= $atasan['nama'] ?>" readonly>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <label for="email" class="form-label">Email</label>
                                                                        <input type="email" class="form-control" id="email" name="email" value="<?= $atasan['email'] ?>" readonly>
                                                                    </div>
                                                                    <div class="col-12">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select name="jabatan" id="jabatan" class="custom-select">
                                                                            <option value="<?= $atasan['jabatan']; ?>"><?= $atasan['jabatan'] ?></option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select name="departement" id="departement" class="custom-select">
                                                                            <option value="<?= $atasan['golongan']; ?>"><?= $atasan['golongan'] ?></option>
                                                                            <?php foreach ($dept as $dp) : ?>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select name="status" id="status" class="custom-select">
                                                                            <option value="<?= $atasan['status']; ?>"><?= $atasan['status'] ?></option>
                                            ...
                                            <span><a type="button" class="badge badge-danger" href="" data-toggle="modal" data-target="#hapusModal<?= $atasan['kd_atasan']; ?>"><i class="fa-solid fa-trash"></i> <span style="font-size:15px;">Hapus</span></a></span>

                                            <!-- Modal Hapus kepegawaian -->
                                            <div class="modal fade" id="hapusModal<?= $atasan['kd_atasan'] ?>" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a type="button" class="btn btn-primary" href="<?= base_url('admin/delete_atasan/' . $atasan['kd_atasan']) ?>">Iya, Saya Yakin</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
