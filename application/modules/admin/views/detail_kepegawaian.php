                ...
                <div class="col-md-8 ml-10">
                    <div class="card card-primary ml-10">
                        <div class="card-header bg-primary">
                            <h5 class="card-heading" style="font-weight: 600; color:white;">Data Kepegawaian</h5>
                        </div>
                        <div class="card-body p-0">
                            <table class="table table-hover table-striped table-hover">
                                <tr>
                                    <td>Nama</td>
                                    <td><b><?php echo $kepegawaian['nama']; ?></b></td>
                                </tr>
                                <tr>
                                    <td>NIP</td>
                                    <td><b><?php echo $kepegawaian['nik']; ?></b></td>
                                </tr>
                                <tr>
                                    <td>Jenis Kelamin</td>
                                    <td><?php
                                ...
                                <tr>
                                    <td>Email</td>
                                    <td><b><?php echo $kepegawaian['email']; ?></b></td>
                                </tr>
                                <tr>
                                    <td>Jabatan</td>
                                    <td><b><?php echo $kepegawaian['jabatan']; ?></b></td>
                                </tr>
                                <tr>
                                    <td>Golongan</td>
                                    <td>
                                        <div class="badge badge-secondary rounded"><b><?php echo $kepegawaian['golongan']; ?></b></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Status</td>
                                    <td>
                                        <b><?php if ($kepegawaian['status'] == 'Aktif') {
                        ...
                        <div class="card-body p-0">
                            <table class="table table-hover table-striped table-hover">
                                <tr class="text-center">
                                    <td><img class="border-right rounded-lg shadow img-thumbnail" src="<?= base_url('assets/data/kepegawaian/profil/' . $kepegawaian['foto']); ?>" alt="foto_peserta" style="width:150px; height:200px;"></td>
                                </tr>
                            </table>
                        </div>
                    </div>
