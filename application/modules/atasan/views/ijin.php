...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xl-6 col-md-6 mb-4">
            <btn href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#ijinModal"><i class="fas fa-download fa-sm text-white-50"></i> Cetak Report</btn>
            <!-- Modal -->
            <div class="modal fade" id="ijinModal" tabindex="-1" aria-labelledby="ijinModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="ijinModalLabel">Cetak Report Ijin</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form action="<?= base_url('atasan/cetak_ijin') ?>" method="post" id="tes2">
                        ...
                        <table class="table table-hover table-bordered dataijin" id="dataijin" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['from']) && isset($_GET['to'])) {
                                    ...
                                    $data = mysqli_query($con, "SELECT k.nama, k.nik, i.* FROM tbl_karyawan k, tbl_ijin i WHERE k.id = i.id_karyawan and i.atasan = '$id' and i.tgl_ijin BETWEEN '" . $_GET['from'] . "' and '" . $_GET['to'] . "'");
                                } else {
                                    //jika tidak ada tanggal dari dan tanggal ke maka tampilkan seluruh data
                                    $data = mysqli_query($con, "SELECT k.nama, k.nik, i.* FROM tbl_karyawan k, tbl_ijin i WHERE k.id = i.id_karyawan and i.atasan = '$id'");
                                }
                                ...
                                ?>
                                    <tr>
                                        ...
                                        if ($d['status'] == 'Disetujui') {
                                            if ($d['jenis'] == 'Normal') {
                                                echo '<td class="text-center"><a href="' . base_url('atasan/cetak_surat/') . $d['id'] . '" class="btn btn-info btn-sm" target="_blank"><b>Cetak</b></a></td>';
                                            } else {
                                                echo '<td class="text-center"><a href="' . base_url('atasan/cetak_cepat/') . $d['id'] . '" class="btn btn-info btn-sm" target="_blank"><b>Cetak</b></a></td>';
                                            }
                                        } else {
        ...
        <br>
        <div class="col-xl-6 col-md-6 mb-4">
            <btn href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#ijinatasanModal"><i class="fas fa-download fa-sm text-white-50"></i> Cetak Report</btn>
            <!-- Modal -->
            <div class="modal fade" id="ijinatasanModal" tabindex="-1" aria-labelledby="ijinatasanModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="ijinatasanModalLabel">Cetak Report Ijin</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form action="<?= base_url('atasan/cetak_ijinatasan') ?>" method="post" id="tes5">
                            <div class="modal-body">
                                <table>
                                    <tr>
                                        <td><b>Periode</b></td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered dataijin" id="dataijin" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['from']) && isset($_GET['to'])) {
                                    // tampilkan data yang sesuai dengan range tanggal yang dicari 
                                    $data = mysqli_query($con, "SELECT k.nama, k.nik, i.* FROM tbl_atasan k, tbl_ijin i WHERE k.kd_atasan = i.id_karyawan and i.atasan = '$id' and i.tgl_ijin BETWEEN '" . $_GET['from'] . "' and '" . $_GET['to'] . "'");
                                } else {
                                    //jika tidak ada tanggal dari dan tanggal ke maka tampilkan seluruh data
                                    $data = mysqli_query($con, "SELECT k.nama, k.nik, i.* FROM tbl_atasan k, tbl_ijin i WHERE k.kd_atasan = i.id_karyawan and i.atasan = '$id'");
                                }
                                while ($d = mysqli_fetch_array($data)) {
                                ?>
                                    <tr>
