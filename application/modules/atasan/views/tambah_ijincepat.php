...
<div class="col-xl-12 col-md-6 mb-6">
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 mb-6">
            ...
            <form action="<?= base_url('atasan/pengajuan_ijincepat') ?>" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                ...
                <input type="hidden" name="id_peserta" value="<?= $foto['kd_atasan'] ?>">
                <input type="hidden" name="tgl_ijin" value="<?php
                                                            date("Y-m-d");
                                                            echo date("Y-m-d");
                                                            ?>">
                <input type="hidden" name="atasan" value="<?= $foto['atasan'] ?>">
