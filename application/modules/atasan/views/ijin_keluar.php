    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="<?= base_url('atasan/tambah_ijin') ?>"><b>Ijin Keluar Kantor &ensp;<i class="fas fa-building"></i></b></a></li>
                <li><a class="dropdown-item" href="<?= base_url('atasan/tambah_ijincepat') ?>"><b>Ijin Keluar Cepat&ensp;&ensp;<i class="fas fa-clock"></i></b></a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="col-xl-12 col-md-12 mb-6">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="fa-regular fa-pen-to-square"></i> Ijin Keluar Kantor Karyawan</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <table class="table table-hover table-bordered dataijin" id="dataijin" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['from']) && isset($_GET['to'])) {
                                    ...
                                    $data = mysqli_query($con, "SELECT k.nik, k.nama, i.waktu_pergi, i.waktu_pulang, i.keperluan, i.tgl_ijin, i.status, i.jenis, i.id_karyawan,i.id as id_ijin from tbl_atasan k, tbl_ijin i where k.kd_atasan = i.id_karyawan and i.id_karyawan = '$id' and i.tgl_ijin BETWEEN '" . $_GET['from'] . "' and '" . $_GET['to'] . "'");
                                } else {
                                    //jika tidak ada tanggal dari dan tanggal ke maka tampilkan seluruh data
                                    $data = mysqli_query($con, "SELECT k.nik, k.nama, i.waktu_pergi, i.waktu_pulang, i.keperluan, i.tgl_ijin, i.status, i.jenis, i.id_karyawan, i.id as id_ijin FROM  tbl_atasan k, tbl_ijin i WHERE  k.kd_atasan = i.id_karyawan and i.id_karyawan = '$id'");
                                }
                                ...
                                ?>
                                    <tr>
                                        ...
                                        if ($d['status'] == 'Disetujui') {
                                            if ($d['jenis'] == 'Normal') {
                                                echo '<td class="text-center"><a href="' . base_url('atasan/cetak_suratdewe/') . $d['id_ijin'] . '" class="btn btn-info btn-sm" target="_blank"><b>Cetak</b></a></td>';
                                            } else {
                                                echo '<td class="text-center"><a href="' . base_url('atasan/cetak_cepatdewe/') . $d['id_ijin'] . '" class="btn btn-info btn-sm" target="_blank"><b>Cetak</b></a></td>';
                                            }
                                        } else {
