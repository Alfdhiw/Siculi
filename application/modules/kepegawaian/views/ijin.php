        ...
        <div class="modal fade" id="cutiModal" tabindex="-1" aria-labelledby="cutiModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('kepegawaian/cetak_ijin') ?>" method="post" id="tes2">
                        ...
                        <table class="table table-hover table-bordered dataijin" id="dataijin" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['from']) && isset($_GET['to'])) {
                                    ...
                                    $data = mysqli_query($con, "SELECT k.nama, k.nik, i.atasan, i.waktu_pergi, i.waktu_pulang, i.keperluan, i.tgl_ijin, i.status, i.id_karyawan, i.jenis, i.id from tbl_karyawan k, tbl_ijin i, tbl_kepegawaian p where i.id_karyawan = k.id and k.kepegawaian = p.kd_kepegawaian and i.kepegawaian = $id  and i.tgl_ijin BETWEEN '" . $_GET['from'] . "' and '" . $_GET['to'] . "'");
                                } else {
                                    //jika tidak ada tanggal dari dan tanggal ke maka tampilkan seluruh data
                                    $data = mysqli_query($con, "SELECT k.nama, k.nik, i.atasan, i.waktu_pergi, i.waktu_pulang, i.keperluan, i.tgl_ijin, i.status, i.id_karyawan, i.jenis, i.id from tbl_karyawan k, tbl_ijin i, tbl_kepegawaian p where i.id_karyawan = k.id and k.kepegawaian = p.kd_kepegawaian and i.kepegawaian = $id ");
                                }
