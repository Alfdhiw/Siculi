            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered dataper" id="dataper" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['from']) && isset($_GET['to'])) {
                                    ...
                                    $data = mysqli_query($con, "SELECT k.email,k.nama, k.nik, c.* from tbl_karyawan k, tbl_cuti c where c.id_karyawan = k.id and c.status = 'Proses' and c.kepegawaian = $id and c.tgl_upload BETWEEN '" . $_GET['from'] . "' and '" . $_GET['to'] . "'");
                                } else {
                                    //jika tidak ada tanggal dari dan tanggal ke maka tampilkan seluruh data
                                    $data = mysqli_query($con, "SELECT k.email,k.nama, k.nik, c.* from tbl_karyawan k, tbl_cuti c where c.id_karyawan = k.id and c.status = 'Proses' and c.kepegawaian = $id");
                                }
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-left">
                                                        <form action="<?= base_url('kepegawaian/edit_persetujuan/') . $d['id']; ?>" method="POST">
                                                            <div class="row g-3">
                                                                <div class="col-md-6">
                                                                ...
                                                                <div class="col-12">
                                                                    ...
                                                                    <input type="text" class="form-control" id="cuti" name="cuti" value="<?php echo date('j F Y', strtotime($d['tgl_cuti'])); ?>" readonly>
                                                                </div>
                                                                <div class="col-12">
                                                                    <label for="masuk" class="form-label">Tanggal Masuk</label>
                                                                    <input type="text" class="form-control" id="masuk" name="masuk" value="<?php echo date('j F Y', strtotime($d['tgl_masuk'])); ?>" readonly>
                                                                </div>
                                                                <div class="col-md-12">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <select name="status" id="status" class="custom-select">
                                                                        ...
                                                                        <option value="Diterima">Approved</option>
