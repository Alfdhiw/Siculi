        ...
        <div class="modal fade" id="cutiModal" tabindex="-1" aria-labelledby="cutiModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('kepegawaian/cetak_laporan') ?>" method="post" id="tes1">
                        ...
                        <table class="table table-hover table-bordered datacuti" id="datacuti" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['from']) && isset($_GET['to'])) {
                                    ...
                                    $data = mysqli_query($con, "SELECT k.nama, k.nik, c.* FROM tbl_karyawan k, tbl_cuti c WHERE k.id = c.id_karyawan and c.kepegawaian = $id and c.tgl_upload BETWEEN '" . $_GET['from'] . "' and '" . $_GET['to'] . "'");
                                } else {
                                    //jika tidak ada tanggal dari dan tanggal ke maka tampilkan seluruh data
                                    $data = mysqli_query($con, "SELECT k.nama, k.nik, c.* FROM tbl_karyawan k, tbl_cuti c WHERE k.id = c.id_karyawan and c.kepegawaian = $id");
                                }
