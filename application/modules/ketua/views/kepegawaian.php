            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered datapegawai" id="datapegawai" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php foreach ($kepegawaian as $kepegawaian) : ?>
                                    <tr>
                                        <td class="text-center"><a href="<?= base_url('ketua/detail_kepegawaian/' . $kepegawaian['kd_kepegawaian'])  ?>"><b><?= $kepegawaian['nik']; ?></b> <i class="fa-solid fa-eye"></i></a></td>
