...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url('ketua/cetak_laporan/') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" target="_blank"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
    </div>
                                ...
                                <?php foreach ($datacuti as $datacuti) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><b><?php if ($datacuti['status'] == 'Approved') {
                                                                    ...
                                                                    } else if ($datacuti['status'] == 'Process Ketua') {
                                                                        echo '<span class="badge bg-warning"><span style="font-size:15px;">Process</span></span>';
                                                                    } else {
                                                                        echo '<span class="badge bg-success"><span style="font-size:15px;">Approved</span></span>';
                                                                    }
                                                                    ?></b></td>
                                    </tr>
                                <?php endforeach; ?>
