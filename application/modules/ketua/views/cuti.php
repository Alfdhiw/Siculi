                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><b><?php if ($d['status'] == 'Disetujui') {
                                                                        ...
                                                                        echo '<span class="badge bg-secondary"><span style="font-size:15px;">Ditangguhkan</span></span>';
                                                                    } else {
                                                                        echo '<span class="badge bg-success"><span style="font-size:15px;">Disetujui</span></span>';
                                                                    }
                                                                    ?></b></td>
            ...
            <div class="modal fade" id="cutiModal" tabindex="-1" aria-labelledby="cutiModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('ketua/cetak_laporanatasan') ?>" method="post" id="tes3">
                            <div class="modal-body">
                                <table>
                                    <tr>
                                        <td><b>Periode</b></td>
        ...
        <div class="col-xl-12 col-md-12 mb-6">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered datacutiatasan" id="datacutiatasan" width="100%" cellspacing="0">
                            <thead class="thead-dark text-center">
                                <tr>
                                    <th>NIP</th>
                                    <th>Nama</th>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><b><?php if ($d['status'] == 'Disetujui') {
                                                                    ...
                                                                    ?></b></td>
                                        <td class="text-center"><a href="<?= base_url('ketua/cetak_cuti/') . $d['id'] ?>" class="btn btn-info btn-sm" target="_blank"><b>Cetak</b></a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
